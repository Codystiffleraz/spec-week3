...
# return a page showing all info about a melon also provide a button to but that melon
...
@app.route("/add_to_cart/<melon_id>")  # add a melon to the shopping cart
def add_to_cart(melon_id):
    ...
    if 'cart' not in session:
        session['cart'] = {}
    # store cart in local variable to make things easier
    cart = session['cart']
